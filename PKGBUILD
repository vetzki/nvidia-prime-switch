...
source=('prime-switch.py' 'prime-switch-conf.json' '99-xrandr-prime.sh' 'intel.conf' 'nvidia.conf' 'intel-modesetting.conf' '999-nvidia-gpu-power.rules' 'nvidia-prime-displaymanager.hook')
sha256sums=(
